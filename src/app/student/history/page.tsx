...
export default function AttendanceHistory() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div>
        <h1 className="text-3xl font-extrabold text-white drop-shadow-md">Attendance History</h1>
        <p className="text-blue-100 mt-1 font-medium">Your complete check-in record across all courses.</p>
      </div>
